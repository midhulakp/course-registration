  ...
  return (
    <div className='navbar'>
        <ul className='nav-items'>
            ...
            <li className='nav-links'> <Link to="/student" className='link'>STUDENT-DETAILS</Link> </li>
            <li className='nav-links'> <Link to="/display" className='link'>TRAINER-DETAILS</Link> </li>
